...
<html lang="en">
  ...
  <form action="add_device_logic.php" method="post" class="container d-flex align-items-center justify-content-center" style="height: 100vh;">
  ...
  <div class="card col-10">
        ...
        <input type="text" class="form-control fw-semibold" name="reg_num" placeholder="enter registration number" />
    </div>
    <div class="col-5">
        <label class="form-label fw-semibold" for="veh_num">Vehicle Number</label>
        <input type="text" class="form-control fw-semibold"  name="veh_num" placeholder="enter vehicle number" />
    </div>
    <div class="col-4">
    ...
    <label class="form-label fw-semibold" for="remarks">Remarks</label>
        <input id ="textboxid" class="form-control fw-semibold"  type="text" name="remarks" placeholder="enter Remarks" />
    </div>
