      ...
      <div class="card-body">
        ...
        <div class="row pb-3">
          <div class="col-5">
            ...
            <select type="text" class="form-control fw-semibold" placeholder="enter registration number" id="reg_no"
              name="reg_no">
          ...
          <div class="col">
            ...
            <input type="text" name="fuel_consumption" class="form-control fw-semibold" placeholder="enter amount"
              id="fuel">
          </div>
          <div class="col-5">
