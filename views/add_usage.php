...
<body>
    <form  action="vehicle_usagelogic.php" method="post" class="container d-flex align-items-center justify-content-center" style="height: 100vh;">
        <div class="card col-10">
            ...
            <div class="card-body">
                ...
                <div class="row pb-3">
                    ...
                    <div id="pickup_date">
    <p><label for="start_date"class="form-label fw-semibold">Start Date:</label><input type="date" class="form-control fw-semibold" id="pick_date" name="pickup_date" onchange="cal()"></p>
  </div>

  <div id="dropoff_date">
    <p><label for="end_date" class="form-label fw-semibold">End Date:</label><input type="date" class="form-control fw-semibold" id="drop_date" name="dropoff_date" onchange="cal()" /></p>
  </div >
  <div id="col">
    <label for="numdays" class="form-label fw-semibold">Number of days:</label><input type="text" class="form-control fw-semibold" id="numdays2" name="numdays" /></div>
  <div class="col">
    <label class="form-label fw-semibold" for="total_distance">Total Distance</label>
    <input type="text" name="total_distance"class="form-control fw-semibold" placeholder="enter distance covered" />
  </div> 
  <div class="col-5">
